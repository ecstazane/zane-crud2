                        ...
                        <>
                            ...
                            <div className="md:hidden p-3 space-y-3">
                                ...
                                {data.map(item => (
                                    <div
                                        key={item._id}
                                        className={`border rounded-xl p-4 transition-all ${selectedIds.has(item._id) ? 'border-neutral-400 bg-neutral-50/50' : 'border-neutral-100 bg-white'}`}
                                    >
                                        ...
                                        <div className="flex items-center gap-4 mt-3 pt-3 border-t border-neutral-100 pl-7">
                                            <button onClick={() => handleRestoreClick(item._id)} className="text-sm text-neutral-600 hover:text-neutral-950 font-bold">
                                                Restore
                                            </button>
                                            <button onClick={() => handleDeleteClick(item._id)} className="text-sm text-neutral-300 hover:text-red-600 font-bold transition-colors">
                                                Delete
                                            </button>
                                        </div>
                                    </div>
